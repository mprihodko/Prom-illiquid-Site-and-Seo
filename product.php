						...
						<nav id="navigation" class="wf-td">
							...
							<ul id="main-nav" class="clearfix">
								<li class="act no-link">
									<a href="#" onclick="return false;" class="topItem">
										<span>
											Home
										</span>
									</a>
							...
							<div class="images">
								...
								<div class="thumbnails clearfix">
									<div class="col-md-4 col-sm-4">
										<a href="img/big-1.jpg" class="fancy" data-fancybox-group="gallery">
											<img src="img/thumb-1.jpg" alt="#" width="400" height="400">
										</a>
									</div>
									<div class="col-md-4 col-sm-4">
										<a href="img/big-2.jpg" class="fancy" data-fancybox-group="gallery"> 
											<img src="img/thumb-2.jpg" alt="#" width="400" height="400">
										</a>
									</div>
									<div class="col-md-4 col-sm-4">
										<a href="img/big-3.jpg" class="fancy" data-fancybox-group="gallery">
										...
										<li>
											<article>
												...
												<div class="post-content">
													<a href="#">Business cards design trends</a>
													<br>
