					...
					<div class="container wf-wrap">
						<div class="row">
							...
							<div class="form-container">
								<form name="login-form" action="#" method="#">
									<div class="form-fields">
										<span class="form-name login-form-input">
											<input type="text" class="validate" placeholder="E-mail *" name="name" value="">
										</span>
										<span class="form-name login-form-input">
											<input type="text" class="validate" placeholder="Пароль *" name="name" value="">
										</span>
									</div>
